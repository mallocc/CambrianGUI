...
namespace gui
{
	...
	enum AlignFlags
	{
		...
		ALIGN_FLAGS_LIST	= ALIGN_FLAGS_TOP | ALIGN_FLAGS_STACKED,
		ALIGN_FLAGS_START	= ALIGN_FLAGS_TOP | ALIGN_FLAGS_LEFT | ALIGN_FLAGS_STACKED,
		ALIGN_FLAGS_END		= ALIGN_FLAGS_BOTTOM | ALIGN_FLAGS_RIGHT | ALIGN_FLAGS_STACKED,
	...
	enum ExpandFlags
	{
		...
		EXPAND_WIDTH_MASK			= EXPAND_PREFERED_WIDTH | EXPAND_FILL_WIDTH,
		EXPAND_PREFERED_HEIGHT		= 0b000000100,
		EXPAND_FILL_HEIGHT			= 0b000001000,
		EXPAND_HEIGHT_MASK			= EXPAND_PREFERED_HEIGHT | EXPAND_FILL_HEIGHT,
