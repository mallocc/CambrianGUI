...
namespace gui
{
	...
	struct Font
	{
		...
		void renderText(std::string text, float x, float y, float scale, bool bold = 0, bool italic = 0, int justify = 0, float lineHeight = 1.2, float textSpacing = 1., coord_t bdims = { 0,0 });
